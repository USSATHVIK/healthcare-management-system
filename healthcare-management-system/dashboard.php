                            ...
                            <div class="d-flex p-3 flex-row ">
                                <div class="card text-center mr-3 " style="width: 15rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Total no. of residents in the shh.</p>
                                ...
                                <div class="card text-center mr-3" style="width: 15rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Total male residents in the shh.</p>
                                ...
                                <div class="card text-center mr-3" style="width: 15rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Total female residents in the shh.</p>
                                ...
                                <div class="card text-center mr-3" style="width: 15rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Total no. of medicines available in the shh.</p>
                                ...
                                <div class="card text-center mr-3" style="width: 15rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Total no. of consumables available in the shh.</p>
                                ...
                                <div class="card text-center mr-3" style="width: 15rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Total no. of appointments today in the shh.</p>
                                ...
                                <div class="card" style="margin-bottom: 15px !important;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <img
                                                    src=" https://wallpaperaccess.com/full/4433956.jpg"
